...
export const RIGHT_DRAWER_PAGE_TITLES = {
  [RightDrawerPages.ViewEmailThread]: 'Conversa de Emails',
  [RightDrawerPages.ViewCalendarEvent]: 'Evento do Calendário',
  [RightDrawerPages.ViewRecord]: 'Editor de Registro',
