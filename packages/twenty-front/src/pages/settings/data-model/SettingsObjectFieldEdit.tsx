        ...
        >
          <SettingsPageContainer>
            <Section>
              <H2Title
                title="Ícone e Nome"
                description="O nome e o ícone deste campo"
              />
            ...
            <Section>
              {fieldMetadataItem.isUnique ? (
                <H2Title
                  title="Valores"
                  description="Os valores deste campo devem ser únicos"
                />
              ) : (
                <H2Title
                  title="Valores"
                  description="Os valores deste campo"
                />
              )}
            ...
            <Section>
              <H2Title
                title="Descrição"
                description="A descrição deste campo"
              />
            ...
            {!isLabelIdentifier && (
              <Section>
                ...
                <Button
                  ...
                  variant="secondary"
                  title={fieldMetadataItem.isActive ? 'Desativar' : 'Ativar'}
                  size="small"
                  onClick={
